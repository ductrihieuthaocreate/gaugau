...
const FOOTER_COLUMNS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Philanthropy", href: "/pages/philanthropy" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Design Challenges", href: "/pages/design-challenges" },
      { label: "Submit Your Ideas", href: "/pages/submit" },
    ],
  },
  {
    title: "Even More",
      ...
      <div className="container-site py-14">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            <Link href="/" className="font-bold text-2xl tracking-[0.15em] uppercase block mb-4">
              GAUGAU
            </Link>
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Playful, functional, and beautifully designed products for everyday life.
            </p>
            {/* Social links */}
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="max-w-md">
            ...
            <p className="text-gray-400 text-sm mb-4">
              New products, special offers, and design inspiration — straight to your inbox.
            </p>
            <NewsletterForm />
          </div>
        </div>
      ...
      <div className="border-t border-gray-800">
        <div className="container-site py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-gray-500 text-xs">
            © {new Date().getFullYear()} Gaugau. All rights reserved.
          </p>
